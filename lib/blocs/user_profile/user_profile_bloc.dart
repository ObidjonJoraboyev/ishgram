...
import 'package:ish_top/blocs/user_profile/user_profile_event.dart';
import 'package:ish_top/blocs/user_profile/user_profile_state.dart';
...
class UserProfileBloc extends Bloc<UserProfileEvent, UserProfileState> {
  ...
  _deleteUser(DeleteUserEvent event, emit) async {
    ...
    NetworkResponse networkResponse =
        await userProfileRepository.deleteUser(event.userModel.docId);
