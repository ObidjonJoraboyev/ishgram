...
class _HiringItemState extends State<HiringItem> {
  ...
  Widget build(BuildContext context) {
    return activeIndexes.isNotEmpty
        ? BlocConsumer<AnnouncementBloc, List<AnnouncementModel>>(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding:
                                        EdgeInsets.only(left: 8.w, top: 3.h),
                                    child: Text(
