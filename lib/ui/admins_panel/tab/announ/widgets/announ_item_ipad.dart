...
class AdminHiringItemIpad extends StatefulWidget {
  const AdminHiringItemIpad(
      {super.key,
  ...
  @override
  State<AdminHiringItemIpad> createState() => _AdminHiringItemIpadState();
}

class _AdminHiringItemIpadState extends State<AdminHiringItemIpad> {
