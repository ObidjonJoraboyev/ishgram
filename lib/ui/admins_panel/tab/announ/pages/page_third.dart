...
class AdminWaitingHires extends StatefulWidget {
  const AdminWaitingHires(
      {super.key,
  ...
  @override
  State<AdminWaitingHires> createState() => _AdminWaitingHiresState();
}

class _AdminWaitingHiresState extends State<AdminWaitingHires> {
              ...
              builder: (BuildContext context, AnnounState state) {
                List<AnnounModel> hires = state.allHires
                    .where((element) =>
                        ...
                        element.status == StatusAnnoun.waiting)
                    .toList();
                return Padding(
